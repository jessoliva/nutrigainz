...
function displayWorkouts() {
  ...
  for (i = 0; i < userWorkouts.length; i++) {
    ...
    workoutSaved.classList = 'm-2 p-2 flex flex-wrap justify-center text-center border-4 border-primary rounded-[26px] border-white md:w-6/12 '
...
var displayRecipes = function(loadedRecipes) {
  ...
  for (var i = 0; i < loadedRecipes.length; i++) {
      ...
      recipeEl.classList = "my-3 mx-2 w-11/12 p-2 flex justify-center bg-primary rounded-xl shadow-md overflow-hidden";
